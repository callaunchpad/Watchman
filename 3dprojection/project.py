        ...
        def move_forward(vis):
            ...
            if record == "play":
                ...
                if curr_loc // 100 > 10:
                    ...
                    o3d.io.write_pinhole_camera_trajectory("./{}_trajectory.json".format(DATASET), traj)

            if curr_loc % (10 if DATASET == 'salsa' else 20) == 0:
                coords = np.load(os.path.join("{}_preds/".format(frame_folder), frame_locations[curr_loc//(10 if DATASET == 'salsa' else 20)]).replace("jpg", "npy"))
