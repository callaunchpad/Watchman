...
if not os.path.isdir("ckpt"):
	print("Hello!!!")
	os.mkdir("ckpt")
	os.mkdir("ckpt/ade20k-resnet50dilated-ppm_deepsup")
	base_url = "http://sceneparsing.csail.mit.edu/model/pytorch/ade20k-resnet50dilated-ppm_deepsup/"
	encoder = base_url + "encoder_epoch_20.pth"
	decoder = base_url + "decoder_epoch_20.pth"
	wget.download(encoder, "ckpt/ade20k-resnet50dilated-ppm_deepsup/encoder_epoch_20.pth")
	wget.download(decoder, "ckpt/ade20k-resnet50dilated-ppm_deepsup/decoder_epoch_20.pth")
...
#Initializing our network, gloabally
